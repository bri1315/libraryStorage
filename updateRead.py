...
def bookRegister():
    ...
    updateStatus = "update "+libraryTable+" set haveIRead = 'yes' where title = '"+title+"'"
...
def updateRead():
    ...
    global libraryTable, canvas, con, cur, bookTable, root
    ...
    addTitle = Label(root, text="Completed reading",fg = "white",
